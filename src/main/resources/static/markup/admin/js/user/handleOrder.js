	...
	for (let i = 0; i < list.length; i++) {
		...
		html += `
			...
			<td data-label="Xem Sp" class="right__iconTable view-detail-order">
				<a class="view-detai-link" style="color: #1e62a6">Xem</a>
            </td>
		</tr>`;
	...
	html+= `
		<div class="d-flex flex-row justify-content-between align-items-center p-2 bg-white mt-2 px-3 "
			style="text-align: center;">
				...
				display: flex; margin-left: 10px; font-size: 16px;
			    color: #fe4c50;
			    font-weight: 600;
			    width: 40%;">
                      Sản phẩm
                       ...
                       <!-- 	<div class="original_price">55&nbsp;₫</div> -->
                            <div class="product_price" style="width: 100px;">Giá tiền</div>
                        </div>
                        
                        <!-- Quantity -->
                        <div class="d-flex flex-rowalign-items-start qty" style="width: 20%">
                            <div class="product_price" style="width: 100px;">Số lượng</div>
                        </div>
                            
                         <!-- total Price Price -->
                        <div style="width: 20%;">
                            <div class="product_price"style="width: 100px;">Thành tiền</div>
                        </div>
					</div>
	`
